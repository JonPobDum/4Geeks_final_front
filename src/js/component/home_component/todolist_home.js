    ...
    return (
        <div className="container bg-light mt-5">
            <div className="container-fluid row">
                <h1 className="display-5 mt-3 mb-3">To Do list</h1>
                ...
                <img className="col-6 mb-5" src="https://user-images.githubusercontent.com/25906896/45767595-35985e00-bc00-11e8-87e0-553c80524c13.gif" />
            </div>
        </div>
    )
};